 ...
 * Retorna lista de músculos alvo (target) disponíveis na ExerciseDB.
 * Alias para /api/exercises/targets conforme especificação.
 */
export async function GET() {
  ...
  try {
    ...
    const res = await fetch(`${base}/exercises/targetList`, {
      method: 'GET',
      headers: {
        'X-RapidAPI-Key': key,
    ...
    const message = e instanceof Error ? e.message : 'Erro ao buscar targets';
