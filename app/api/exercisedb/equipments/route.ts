 ...
 * Retorna lista de equipamentos disponíveis na ExerciseDB.
 * Alias para /api/exercises/equipment conforme especificação.
 */
export async function GET() {
  ...
  try {
    ...
    const message = e instanceof Error ? e.message : 'Erro ao buscar equipamentos';
