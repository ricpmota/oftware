...
export default function EditEscalaForm({ escala, locais, servicos, residentes, onSave, onCancel }: EditEscalaFormProps) {
  ...
  const getParticipacaoResidente = (residenteEmail: string, servicoId: string, localId: string) => {
    ...
    // Contar participações em escalas existentes (não incluindo a escala atual sendo editada)
