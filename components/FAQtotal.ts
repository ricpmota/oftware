...
export const faqPlatformDoctor: FAQItem[] = [
  {
    question: "Como gerenciar meus pacientes?",
    answer: "Na área de administração, você pode visualizar todos os seus pacientes, acompanhar sua evolução, ajustar doses, visualizar exames e enviar mensagens. Use os filtros e buscas para encontrar pacientes específicos rapidamente."
  },
  {
    question: "Como ajustar a dose de um paciente?",
    answer: "Acesse o perfil do paciente, vá até a seção de Plano Terapêutico e clique em 'Ajustar Dose'. O sistema calculará automaticamente a próxima dose recomendada baseada no histórico e evolução do paciente."
  },
  {
    question: "Como visualizar alertas e notificações?",
    answer: "Alertas importantes aparecem no topo da página do paciente. Você também pode verificar a aba de Alertas para ver todos os alertas ativos, incluindo sintomas graves, falta de adesão ao tratamento e exames pendentes."
  }
];
